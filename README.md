...
I'm currently developing interactive web applications using the latest web technologies. In my spare time, I enjoy exploring the world of JavaScript frameworks and Firebase to create cool applications, and I frequently publish articles on a variety of topics while exploring on my [hashnode blog](https://forjessicasake.hashnode.dev)
